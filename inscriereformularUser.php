...
<head>
	...
	<link href="https://fonts.googleapis.contentm/css?family=Anton" rel="stylesheet">
...
<body>
	...
	<form action="inscriereformular.php" method="POST" enctype="multipart/form-data">	 
		<h1>Petition Title</h1>
		<p>Something catchy and not too long</p>
		<input name="title" type="text" class="titleinput" maxlength="30" required>
		<hr class="style-four">
		<h1>Petition text</h1>
		<p>Don't worry if you don't have the final text ready now. You can always fine tune it later.</p>
		<textarea name="description" class="editor" required></textarea>
		<hr class="style-four">
